    ...
    return (
        <Container sx={{ marginBottom: 100 }}>
            <Box sx={{ display: "flex", justifyContent: "center", marginBottom: "20px" }}>
                ...
                <ButtonGroup>
                    <Button variant={dailyActive ? "contained" : "outlined"} color={dailyActive ? "secondary" : "primary"} onClick={toggleDaily}>
                        Daily
                    </Button>
                    <Button variant={dailyActive ? "outlined" : "contained"} color={dailyActive ? "primary" : "secondary"} onClick={toggleHourly}>
                        Hourly
                    </Button>
                </ButtonGroup>
            </Box>
